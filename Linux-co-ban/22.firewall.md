...
* **public**: Đại diện cho các mạng công cộng, không đáng tin cậy. Bạn không tin tưởng các máy tính khác nhưng có thể cho phép các kết nối đến được chọn trên cơ sở từng trường hợp cụ thể. (Reject incoming)
* **external**: Mạng bên ngoài trong trường hợp bạn sử dụng firewall làm cổng của mình. Nó được cấu hình để NAT giả mạo mạng nội bộ của bạn vẫn ở chế độ riêng tư nhưng có thể truy cập được. (Reject incoming)
* **internal**: Mặt khác của vùng bên ngoài, được sử dụng cho phần bên trong của cổng. Các máy tính khá đáng tin và một số dịch vụ bổ sung có sẵn. (Reject incoming)
* **dmz**: Được sử dụng cho các máy tính nằm trong DMZ (các máy tính bị cô lập sẽ không có quyền truy cập vào phần còn lại của mạng của bạn). Chỉ cho phép một số kết nối đến. (Reject incoming)
* **work**: Được sử dụng cho các máy làm việc. Tin tưởng hầu hết các máy tính trong mạng. Một vài dịch vụ khác có thể được cho phép. (Reject incoming)
* **home**: Một môi trường nhà riêng. Nó thường ngụ ý rằng bạn tin tưởng hầu hết các máy tính khác và một vài dịch vụ khác sẽ được chấp nhận. (Reject incoming)
* **trusted**: Tin tưởng tất cả các máy trong mạng. Mở hầu hết các tùy chọn có sẵn và nên được sử dụng một cách tiết kiệm. (allow all incoming)
