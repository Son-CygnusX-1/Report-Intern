...
### 1.2 Quy tắc vĩnh viễn (Permanent)
...
## 1.3 Cài đặt và kích hoạt Firewall của bạn để bắt đầu khi khởi động
...
## 3. Chọn vùng cho giao diện của bạn

### 3.1 Thay đổi vùng giao diện
...
```
#### 3.3.2 Điều gì xảy ra khi không có dịch vụ phù hợp?
